...
def load_crime_dataset():
    ...
    crime = pd.read_table('https://raw.githubusercontent.com/diplomado-bigdata-machinelearning-udea/Curso1/master/s06/CommViolPredUnnormalizedData.txt', sep=',', na_values='?')
